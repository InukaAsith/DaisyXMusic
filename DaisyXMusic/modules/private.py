...
def _start(client, message):
    ...
    try:
     ...
     reply_me = message.reply_text(f"**Hey {message.from_user.mention} You Should Join My Channel To Use Me!!**\n\n**⭕Link ~ @Itz_Alain**", reply_markup=InlineKeyboardMarkup([InlineKeyboardButton("Join Channel", url="t.me/Itz_Alain")]))
     return
    client.send_message(
        message.chat.id,
